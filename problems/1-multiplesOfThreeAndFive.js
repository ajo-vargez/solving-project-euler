 ...
 *
 * @param {Number} upperbound - The number upto which we need to find the multiples of 3 & 5.
 * @returns - The sum of all the multiples of 3 & 5.
 */
const sumOfMultiplesOfThreeAndFive = (upperbound) => {
	// Initialise the sum.
...
console.log(
	"The sum of all the multiples of 3 and 5 are " +
		sumOfMultiplesOfThreeAndFive(upperbound)
);
